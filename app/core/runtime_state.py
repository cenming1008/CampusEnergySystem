...
class RuntimeState:
    ...
    def __init__(self) -> None:
        ...
        self._state: dict[str, Any] = {
            "services": {
                ...
                "mqtt_bridge": self._service_payload("unknown"),
                "api_realtime": self._service_payload("unknown"),
            ...
            "counters": {
                ...
                "mqtt_bridge_messages_total": 0,
                "mqtt_bridge_publish_total": 0,
                "mqtt_bridge_publish_failures_total": 0,
                "mqtt_api_broadcast_total": 0,
                "mqtt_api_broadcast_failures_total": 0,
                "mqtt_replay_success_total": 0,
                "mqtt_replay_failure_total": 0,
                "mqtt_replay_skipped_total": 0,
    ...
    def mark_service(
        ...
        with self._lock:
            self._state["services"][name] = self._service_payload(status, detail, meta)
