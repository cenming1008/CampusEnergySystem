...
import StorageEmsWorkspace from '@/features/energy-management/storage-ems/StorageEmsWorkspace.vue'
...
const activeWorkspace = ref<'overview' | 'storage_ems'>('overview')
  ...
  <div class="em-page park-ems-report">
    ...
    >
      <button
        ...
        :class="{ active: activeWorkspace === 'overview' }"
      ...
      <button
        type="button"
        data-testid="workspace-storage-ems"
        :class="{ active: activeWorkspace === 'storage_ems' }"
        :aria-pressed="activeWorkspace === 'storage_ems'"
        @click="activeWorkspace = 'storage_ems'"
      >
        光储 EMS
      </button>
    </nav>
