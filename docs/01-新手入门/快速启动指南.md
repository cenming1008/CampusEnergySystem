# 🚀 MineEnergySystem 快速启动指南

> 本指南帮助您在 3 分钟内启动煤矿综合能源管理系统
...
# NAME              STATUS          PORTS
# mine_backend      Up 30 seconds   0.0.0.0:8088->8088/tcp
# mine_energy_db    Up 35 seconds   0.0.0.0:5433->5432/tcp
# mine_mqtt         Up 35 seconds   0.0.0.0:1883->1883/tcp
# ems_redis         Up 35 seconds   0.0.0.0:6379->6379/tcp
```
...
# 执行测试查询
mine_energy=# SELECT version();
mine_energy=# \dt  # 查看所有表
mine_energy=# \q   # 退出
```
...
# 直接执行命令
docker exec mine_backend ls -la
```
