...
一次性修复说明、聊天式应急操作和待确认删除候选，已迁入 `docs/archive/`：

- 已归档：`docs/archive/故障排查/`
- 待人工确认删除：`docs/archive/pending-delete/故障排查/`

当前目录只保留可复用、仍有稳定价值的排障入口。
...
- 优化数据库查询
- 增加 uvicorn workers
- 查看 [../03-开发与部署/后端容量基线指南.md](../03-开发与部署/后端容量基线指南.md)
